...
const arrayWords = ["Batman","Emmet", "Yoda", "Luke", "Spaceship", "Hogwarth", "Harry", "Dumbledore", "Brick", "Construction", "Amusing", "Imagination", "Legoman", "Danemark", "Legoland", "Building", "Duplo"];
...
for (let touche of touches){ 
  touche.addEventListener('click', function(){ 
    ...
    if (counter === word.length){
      ...
      document.querySelector('#command').innerHTML += `<a href="indexV2.html" class="key">Restart</button>`; 
    }
    if (!found){
      errors++;
